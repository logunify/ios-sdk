...
struct UserActivity {
  ...
  var stringIntMap: [UserActivity.string_int_mapEntry] = []

  var unknownFields = SwiftProtobuf.UnknownStorage()

  struct string_int_mapEntry {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension UserActivity.string_int_mapEntry: @unchecked Sendable {}
...
extension SwiftProtobuf.Google_Protobuf_FileOptions {
  ...
  var apiKey: String {
    get {return getExtensionValue(ext: Extensions_API_KEY) ?? String()}
    set {setExtensionValue(ext: Extensions_API_KEY, value: newValue)}
  }
  /// Returns true if extension `Extensions_API_KEY`
  /// has been explicitly set.
  var hasApiKey: Bool {
    return hasExtensionValue(ext: Extensions_API_KEY)
  }
  /// Clears the value of extension `Extensions_API_KEY`.
  /// Subsequent reads from it will return its default value.
  mutating func clearApiKey() {
    clearExtensionValue(ext: Extensions_API_KEY)
  }
}
...
let Extensions_API_KEY = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalExtensionField<SwiftProtobuf.ProtobufString>, SwiftProtobuf.Google_Protobuf_FileOptions>(
...
extension UserActivity: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 8: try { try decoder.decodeRepeatedMessageField(value: &self.stringIntMap) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.stringIntMap.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.stringIntMap, fieldNumber: 8)
    }
...
extension UserActivity.string_int_mapEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = UserActivity.protoMessageName + ".string_int_mapEntry"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "key"),
    2: .same(proto: "value"),
  ]
  ...
  static func ==(lhs: UserActivity.string_int_mapEntry, rhs: UserActivity.string_int_mapEntry) -> Bool {
